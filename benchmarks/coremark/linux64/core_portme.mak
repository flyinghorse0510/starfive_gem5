...
#CC = /ssd/share/tools/riscv-gcc-10.2.0/bin/riscv64-unknown-elf-gcc
CC = riscv64-unknown-elf-gcc
# Flag: CFLAGS
#	Use this flag to define compiler options. Note, you can add compiler options from the command line using XCFLAGS="other flags"
PORT_CFLAGS = -O2 ${DEFINES} -funroll-loops -DPREALLOCATE=1 -mcmodel=medany -std=gnu11 -fno-common -fno-builtin-printf -march=rv64imafdc -mabi=lp64d -finline-functions --param max-inline-insns-auto=20 -falign-functions=4 -falign-jumps=4 -falign-loops=4 -lm -lgcc
#PORT_CFLAGS = -O3 -funroll-loops -DPREALLOCATE=1 -mcmodel=medany -std=gnu99 -fno-common -fno-builtin-printf -march=rv64imafdc -mabi=lp64d -nostartfiles -lm -lgcc
FLAGS_STR = "$(PORT_CFLAGS) $(XCFLAGS) $(XLFLAGS) $(LFLAGS_END)"
CFLAGS = $(PORT_CFLAGS) -I$(PORT_DIR) -I. -DFLAGS_STR=\"$(FLAGS_STR)\" -I../common/ -I$(GEM5_HOME)/include
#Flag: LFLAGS_END
#	Define any libraries needed for linking or other flags that should come at the end of the link line (e.g. linker scripts). 
#	Note: On certain platforms, the default clock_gettime implementation is supported but requires linking of librt.
# LFLAGS_END += -lrt
# LFLAGS_END += -Tlinux64/link.ld
# Flag: PORT_SRCS
# Port specific source files can be added here
PORT_SRCS = $(PORT_DIR)/core_portme.c #$(PORT_DIR)/syscalls.c ../common/crt.S
# Flag: LOAD
...
port_postbuild:
	./elf2hex --bit-width 512 --input coremark$(EXE) --output coremark.hex
	riscv64-unknown-elf-objdump -D coremark$(EXE) > coremark.dmp
