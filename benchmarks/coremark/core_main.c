...
#error "Please define a way to initialize a memory block."
	...
	//display();
	//ee_printf("mcycle           : %d\n", (long unsigned) counters[0]);	//hyper add to display mcycle
	//ee_printf("minstret         : %d\n", (long unsigned) counters[1]);	//hyper add to display minstret
    ...
    ee_printf("Score            : %f CMK/MHz\n",1000000/((float)total_time/(default_num_contexts*results[0].iterations)));
	return MAIN_RETURN_VAL;
}
